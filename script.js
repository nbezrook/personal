...
function createMiniWinLayer(mainContent,oTitle,oLeft,oTop,oWidth,barColour,mainColour,oLogo,oMin,oMax,oClose,oFull,oDrag,oVis,oFullDrag,anyExtra,oScroll) {
	...
	if( document.layers && !document.childNodes ) {
		...
		document.write(
			...
			(document.childNodes?('<div style="position:absolute;right:2px;bottom:2px;">'+((oDrag&&!oFullDrag)?'<img src="'+oDrag+'" height="8" width="8" border="0" alt="Resize." title="Resize." onmousedown="clickDiv(\'MWJminiwinMAX'+window.MWJ_MINIWINS+'\',\'MWJminiwinMIN'+window.MWJ_MINIWINS+
			...
			'<a style="text-decoration:none;cursor:default;" href="javascript:showMinWin(\'MWJminiwinMIN'+window.MWJ_MINIWINS+'\',\'MWJminiwinMAX'+window.MWJ_MINIWINS+'\');" onfocus="this.blur()" onmouseover="window.status=\'Click to minimise the mini window\';return true;" onmouseout="window.status=\'\';return true;" title="Minimise.">'+
			'<img src="'+oMin+'" border="0" height="16" width="16" alt="Minimise."></a>'+
			...
			'<a style="text-decoration:none;cursor:default;" href="javascript:hideMinWin(\'MWJminiwinMAX'+window.MWJ_MINIWINS+'\');" onfocus="this.blur()" onmouseover="window.status=\'Click to close the mini window\';return true;" onmouseout="window.status=\'\';return true;" title="Close.">'+
		...
		document.write(
			...
			'onmouseover="window.status=\'Drag here to move the mini window\';return true;" onmouseout="window.status=\'\';return true;"'+
			(oFullDrag?'':theDragString)+' nowrap>'+oTitle+'</td><td bgcolor="'+barColour+'" align="right" valign="middle" width="34"><nobr>'+
			'<a style="text-decoration:none;cursor:default;" href="javascript:showMinWin(\'MWJminiwinMAX'+window.MWJ_MINIWINS+'\',\'MWJminiwinMIN'+window.MWJ_MINIWINS+'\');" onfocus="this.blur()" onmouseover="window.status=\'Click to restore the mini window\';return true;" onmouseout="window.status=\'\';return true;" title="Restore.">'+
			...
			'<img src="'+oFull+'" border="0" height="16" width="16" alt="Maximise."></a>':'')+
			'<a style="text-decoration:none;cursor:default;" href="javascript:hideMinWin(\'MWJminiwinMIN'+window.MWJ_MINIWINS+'\');" onfocus="this.blur()" onmouseover="window.status=\'Click to close the mini window\';return true;" onmouseout="window.status=\'\';return true;" title="Close.">'+
			'<img src="'+oClose+'" border="0" height="16" width="16" alt="Close."></a></nobr></td></tr></table>'+
